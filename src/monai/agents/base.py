    ...
    def search_web(self, query: str, extraction_prompt: str,
        ...
        if not search_results:
            ...
            return self.execute_task(
                ...
                "1. https://search.sapti.me/search?q=YOUR+QUERY (SearXNG, best over Tor)\n"
                "2. https://searx.be/search?q=YOUR+QUERY (SearXNG backup)\n"
                "3. https://opnxng.com/search?q=YOUR+QUERY (SearXNG backup)\n"
                "4. https://lite.duckduckgo.com/lite/?q=YOUR+QUERY\n"
